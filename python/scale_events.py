...
def root_information(infile,outfile,weight,event):
    ...
    h[22] = f.Get('after_second_cut_Pz')
    ...
    h[36] = f.Get('after_fourth_cut_Pz')
    ...
    h[57] = f.Get('after_seventh_cut_Pz')
