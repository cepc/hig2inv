...
k=0
flag=0
n=`ls /cefs/data/DstData/CEPC240/CEPC_v4/4fermions/E240.Pww_sl.e0.p0.whizard195/ww_sl0tauq*slcio -l | grep "^-" | wc -l`
let "n = $n - 1"
for SLCIO in `ls /cefs/data/DstData/CEPC240/CEPC_v4/4fermions/E240.Pww_sl.e0.p0.whizard195/ww_sl0tauq*slcio -l | awk '{print $9}'`
do
	if [ $flag == 0 ]; then
