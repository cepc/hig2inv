...
void HinvApplication_4fermions( TString myMethodList = "" )
{
#ifdef __CINT__
	...
	reader->BookMVA("BDTG","weights/bkg_e2e2h_4fermions_BDTG.weights.xml");

	TFile *f_sig =TFile::Open("../sel/signal_e2e2h.root");
	TTree* TreeS_bbaa = f_sig->Get("MCPart");

	TFile *f_bkg= TFile::Open("../sel/bkg_e2e2h_4fermions.root");
	...
	TFile f_S("../BDT_output/Hinv_sig_e2e2h_4fermions_BDT.root","recreate");
	...
	TFile f_B("../BDT_output/Hinv_bkg_e2e2h_4fermions_BDT.root","recreate");
