...
void Hinv_4fermions( TString myMethodList = "" )
{
	...
	//TString bkgname[1]="bkg_e2e2h_4fermions";

	//Create a ROOT output file where TMVA will store ntuples, histograms, etc.
	//TString outfileName( "../BDT_output/"+bkgname[0]+".root" );
	//TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
	TString outfileName( "../BDT_output/bkg_e2e2h_4fermions.root" );
	TFile* outputFile = TFile::Open( outfileName, "RECREATE" );
	
	//TMVA::Factory *factory = new TMVA::Factory( bkgname[0], outputFile,"!V:!Silent:Color:AnalysisType=Classification" );
	TMVA::Factory *factory = new TMVA::Factory( "bkg_e2e2h_4fermions", outputFile,"!V:!Silent:Color:AnalysisType=Classification" );
	...
	TFile *inputB = TFile::Open("../sel/bkg_e2e2h_4fermions.root");
